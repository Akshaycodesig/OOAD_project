...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        l1.setBounds(650,330,800,35);
        l4.add(l1);
        
        l2.setBounds(580,390,150,35);
        l4.add(l2);
        
        l3.setBounds(580,440,200,35);
        l4.add(l3);
        
        t1.setBounds(750,390,180,25);
        l4.add(t1);
        
        t2.setBounds(750,440,180,25);
        l4.add(t2);
